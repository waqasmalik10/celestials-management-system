...
const DashboardBody = () => {
  ...
  useEffect(() => {
    fetch("/dummy_json_data/dashboard_json_data/card.json")
      .then((res) => res.json())
  ...
  return (
    ...
    <div className="relative">
      ...
      <button onClick={handleLeftArrow} type="button" className="w-[65px] h-[65px] absolute -left-8 top-[101px]">
        <img src={sliderCardLeftArrow} alt="arrow" className="w-full h-auto" />
      </button>
      <button onClick={handleRightArrow} type="button" className="w-[65px] h-[65px] absolute -right-8 top-[101px]">
        <img src={sliderCardRightArrow} alt="arrow" className="w-full h-auto" />
      </button>
    </div>
    <MarketStats />
    <Portfolio />
